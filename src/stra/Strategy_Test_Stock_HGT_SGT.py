...
class Strategy_Test_Stock_HGT_SGT(strategy_base.StrategyBase):
    def __init__(self):
        strategy_base.StrategyBase.__init__(self, "Strategy_Test_Stock_HGT_SGT", "Test_Stock_HGT_SGT", "沪深港通行情测试")
        self.log_cate = "Strategy_Test_Stock_HGT_SGT"
        self.beat_calc = BeatCalc(self)
        
        self.subscribe = False # 行情订阅标志
        self.center = center.Center()
        
        self.symbol_hgt = "02318"
        self.symbol_sgt = "02202"
        self.price_round_s = 3 # 港股股票类价格需精确到小数点后三位
    ...
    def OnQuoteStock(self, msg): # 行情触发
        try:
            ...
            if str_code == self.symbol_hgt or str_code == self.symbol_sgt:
...
class BeatCalc():
    ...
    def MakeCalc(self):
        self.log_cate = "Strategy_Test_Stock_HGT_SGT"
        self.log_text = "Strategy_Test_Stock_HGT_SGT"
